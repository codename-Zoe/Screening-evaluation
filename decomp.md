<!-- I am very sorry but I don't have ReactJS experience -->
<!-- However, I added some answers that I could write in React -->
...
// I would re-write this code in React Native
//
//import React, {useState} from 'react';
// function Counter(props) {
...
```
<!-- Line 68:  it pops up an alert window with 'MyComponent' -->
<!-- Line 69:  I don't know the answer -->
<!-- Line 70:  I don't know the answer -->
<!-- Line 71:  I don't know the answer -->
